...
class MeteoFranceOptions(Option):
    ...
    """
    def __init__(self, latitude, longitude,elevation = nan,current_weather = False,temperature_unit = celsius,windspeed_unit =kmh ,  precipitation_unit = mm,timeformat = iso8601, timezone = UTC, past_days = 0,start_end = False,start_date = None,end_date = None,cell_sellection = land):
        """
        Args:
